...
11. Home'daki “Bugün ne çalışalım?” panelinden Kelime, Hatalar, Konuşma pratiği, AI ve Sınav girişlerini aç.
12. Hatalarım bölümünü aç.
13. Yol haritasında A0/A1 derslerini açmayı dene.
14. A0/A1/A2 dersleri açılıyor mu, B1'de yalnızca sekiz kısa “B1 Ön İzleme” dersi görünüyor mu, tam B1/B2 modüllerinde yakında mesajı görünüyor mu kontrol et.
15. Wolli chat'e kısa bir A1 mesaj yaz; derse göre öneri çipleri görünüyorsa dene.
16. Konuşma Pratiği'nde 36 hazır cümle ve konuşma istatistikleri paneli görünüyor mu kontrol et.
17. Sesli pratikte mikrofon butonuna basılı tut, Almanca cümleyi söyle, bırak ve dinle.
18. Bırakınca analiz animasyonu başlıyor mu kontrol et.
19. Sonuçta şunları kontrol et: Beklenen cümle, Söylediğin cümle, Hedefe yakınlık, Pratik geri bildirimi.
20. Başarılı bir konuşma sonucundan sonra konuşma istatistikleri artıyor mu kontrol et.
21. Profil'den alpha test günlüğünü dışa aktar.
...
- Konuşma geri bildirimi gerçek fonetik telaffuz puanı değildir; transcript tabanlı Hybrid Speech Scoring v1 sonucuna dayanır.
