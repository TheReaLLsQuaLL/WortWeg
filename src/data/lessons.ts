...
import { lessonsC1 } from './lessons.c1';
import { lessonsC2 } from './lessons.c2';
import { lessonsExam } from './lessons.exam';
...
export const playableLessons: Lesson[] = [...mainPathLessons, ...lessonsB1Preview, ...lessonsB2, ...lessonsC1, ...lessonsC2, ...lessonsExam];
...
export { lessonsA0, lessonsA1, lessonsA2, lessonsB2, lessonsC1, lessonsC2, lessonsExam };
