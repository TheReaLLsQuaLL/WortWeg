...
export const modulesA2: CurriculumModule[] = [
  {
    ...
    "readingTasks": [
      "tren ile ilgili kısa not veya mesajdan ana bilgiyi bul.",
      "Anahtar kelimeleri renkli etiketlerle eşleştir."
    ],
    "writingTasks": [
      "tren hakkında bir kısa cümle yaz.",
  ...
  },
  {
    ...
    "readingTasks": [
      "mahalle ile ilgili kısa not veya mesajdan ana bilgiyi bul.",
      "Anahtar kelimeleri renkli etiketlerle eşleştir."
    ],
    "writingTasks": [
      "mahalle hakkında bir kısa cümle yaz.",
      "Kısa form veya mesaj boşluğunu doldur."
    ],
    "examTasks": [
      "Kısa okuma veya dinleme bilgisini seç.",
  ...
  },
  {
    ...
    "readingTasks": [
      "doktor ile ilgili kısa not veya mesajdan ana bilgiyi bul.",
      "Anahtar kelimeleri renkli etiketlerle eşleştir."
    ],
    "writingTasks": [
      "doktor hakkında bir kısa cümle yaz.",
      "Kısa form veya mesaj boşluğunu doldur."
    ],
    "examTasks": [
      "Kısa okuma veya dinleme bilgisini seç.",
  ...
  },
  {
    ...
    "readingTasks": [
      "meslek ile ilgili kısa not veya mesajdan ana bilgiyi bul.",
      "Anahtar kelimeleri renkli etiketlerle eşleştir."
    ],
    "writingTasks": [
      "meslek hakkında bir kısa cümle yaz.",
      "Kısa form veya mesaj boşluğunu doldur."
    ],
    "examTasks": [
      "Kısa okuma veya dinleme bilgisini seç.",
