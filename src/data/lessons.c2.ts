...
export const lessonsC2: Lesson[] = [
  makeLesson({
    ...
    baseExercises: c2Exercises({
      ...
      trDe: { question: 'O sonunda hatasını idrak etti.', correct: 'Er hat seinen Fehler endlich eingesehen.', explanation: 'Fehler einsehen = hatasını idrak etmek.' },
  ...
  makeLesson({
    ...
    baseExercises: c2Exercises({
      ...
      trDe: { question: 'Proje hayata geçirildi.', correct: 'Das Projekt wurde ins Leben gerufen.', explanation: 'etw. ins Leben rufen = hayata geçirmek, kurmak.' },
  ...
  makeLesson({
    ...
    baseExercises: c2Exercises({
      ...
      trDe: { question: 'Buradan ... sonucu çıkarılabilir.', correct: 'Daraus lässt sich schlussfolgern, dass...', explanation: 'schlussfolgern = sonuç çıkarmak.' },
  ...
  makeLesson({
    ...
    baseExercises: c2Exercises({
      ...
      trDe: { question: 'O arabulucu işlevi (görevi) görüyor.', correct: 'Er fungiert als Vermittler.', explanation: 'fungieren als = ... olarak işlev görmek/görev yapmak.' },
